...
describe('Testing Action and Action Creator', () => {
  ...
  it('Creates asteroidAction:get success when fetching Asteroids has been done', () => {
    ...
    fetchMock.get(`${apiConfig.url}/feed?start_date=${startDate}&end_date=${endDate}&api_key=${apiConfig.apiKey}`, data);

    return store.dispatch(asteroidAction.get({start_date: startDate, end_date: endDate})).then(() => {
